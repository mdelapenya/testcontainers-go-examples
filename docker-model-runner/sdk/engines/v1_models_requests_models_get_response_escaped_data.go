...
func CreateV1ModelsRequestsModelsGetResponse_dataFromDiscriminatorValue(parseNode sdkserialization.ParseNode) (sdkserialization.Parsable, error) {
...
func (m *V1ModelsRequestsModelsGetResponse_data) GetFieldDeserializers() map[string]func(sdkserialization.ParseNode) error {
	...
	res["owned_by"] = func(n sdkserialization.ParseNode) error {
		val, err := n.GetStringValue()
		if err != nil {
			return err
		}
...
func (m *V1ModelsRequestsModelsGetResponse_data) Serialize(writer sdkserialization.SerializationWriter) error {
	{
