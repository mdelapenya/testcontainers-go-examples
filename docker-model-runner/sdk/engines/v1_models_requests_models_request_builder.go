...
func NewV1ModelsRequestsModelsRequestBuilderInternal(pathParameters map[string]string, requestAdapter sdkabstractions.RequestAdapter) *V1ModelsRequestsModelsRequestBuilder {
	m := &V1ModelsRequestsModelsRequestBuilder{
		BaseRequestBuilder: *sdkabstractions.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/engines/v1/models", pathParameters),
	}
	return m
}
...
func NewV1ModelsRequestsModelsRequestBuilder(rawUrl string, requestAdapter sdkabstractions.RequestAdapter) *V1ModelsRequestsModelsRequestBuilder {
...
func (m *V1ModelsRequestsModelsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *V1ModelsRequestsModelsRequestBuilderGetRequestConfiguration) (*sdkabstractions.RequestInformation, error) {
